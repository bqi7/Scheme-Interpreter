...
(define a (eval (define a 5)))
; expect a

(eval (define a (eval (define a 5))))
; expect 5
...
(car (eval '(quote '(quote))))
; expect quote

(+ '1 (quote 2))
; expect 3

(= (car (quote (1 2))) (car '(1 2)))
; #t
...
'(scheme is cool!)
; expect (scheme is cool!)

(begin (display 1) (quote 2))
; expect 12
...
(begin (begin 1) (begin 1 2) (begin 1 2 3))
; expect 3
...
(define (x y) (lambda (z) (z)))
; expect x

(x 1)
; expect (lambda (z) (z))

((lambda (a) (define (b c) (lambda (d) (* a b c d)))) 1)
; expect b

((((lambda () (lambda () (lambda () '(scheme!)))))))
; expect (scheme!)

(define (a b) (define (c d) (define (e f) (0))))
; expect a

a
; expect (lambda (b) (define (c d) (define (e f) (0))))
...
((lambda (x) (cond ((< x 0) 'small)
                  ((= x 0) 'normal)
                  (else 'small 'medium 'large))) 10)
; expect large
